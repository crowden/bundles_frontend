    ...
    render(){
        ...
        const md_helper_linebreaks = (
          <Popover id="popover-trigger-click-root-close" title="Line Breaks">
              ...
              <p className="md-help-popover-example">How do I love thee?<span className="spaces">{'\xa0\xa0'}</span><br/>Let me count the ways.</p>
          </Popover>
        );
        const md_helper_bold_italics = (
          <Popover id="popover-trigger-click-root-close" title="Bold and Italics">
              ...
              <p className="md-help-popover-example">*This is italicized*, and so is _this_.<br/><br/>**This is bold**, and so is __this__.<br/><br/>Use ***italics and bold together*** if you ___have to___.</p>
          </Popover>
        );
        const md_helper_links = (
          <Popover id="popover-trigger-click-root-close" title="Links">
              ...
              <p className="md-help-popover-example">Here is a link to [Google](http://www.google.com/ "go to Google's homepage!"). Based on the explanation above, a link is [the link text](http://www.destination "hover text")</p>
          </Popover>
        );
        const md_helper_subheadings = (
          <Popover id="popover-trigger-click-root-close" title="Subheadings">
              <p className="md-help-popover-explanation">Subheadins break up content into different sections for your readers. Usually, you should only be adding subheadings 2-3 levels deep. Heading 1's are reserved for page titles and will be removed if added.</p>
              <p className="md-help-popover-example">## Heading 2<br />### Heading 3<br />#### Heading 4</p>
          </Popover>
        );
        ...
        const md_helper_lists = (
          <Popover id="popover-trigger-click-root-close" title="Lists">
              ...
              <p className="md-help-popover-example">
                A bulleted list:
                <br />- Use a hyphen for each bulleted list item
                <br />- Use a hyphen for each bulleted list item
                <br />- Use a hyphen for each bulleted list item
                <br /><br />
                An ordered list:
                <br />1. Numbered lists are easy
                <br />2. Markdown keeps track of the numbers for you
                <br />7. So this will be item 3.
              </p>
          </Popover>
        );
        const md_helper_nested_lists = (
          <Popover id="popover-trigger-click-root-close" title="Nested Lists">
              ...
              <p className="md-help-popover-example">
                ...
                <span className="spaces">{'\xa0\xa0\xa0\xa0'}</span>- Indented four spaces.<br />
                <span className="spaces">{'\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0'}</span>- indented eight spaces.<br />
                <span className="spaces">{'\xa0\xa0\xa0\xa0'}</span>- Indented four spaces again.
              </p>
          </Popover>
        );
